...
const QnaPage = () => {
  return (
    <Container>
      <SearchBar text='Q&A에서 검색' />
      <ContentWrapper>
        <Header>
          <HeaderTitle>Q&A</HeaderTitle>
          <HeaderLink to='/community/qna/total'>전체보기</HeaderLink>
        </Header>
        <ItemList>
          <Item
            title='Q&A'
          ...
          <Item
            ...
            content='새끼때부터 키우던게 엊그제 같은데 벌써 이렇게나 세 쌍둥이를 낳았어요! 이름은 뭐로 할지 고민이...'
